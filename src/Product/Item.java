...
public class Item implements Comparable<Item> {
	 ...
	 */
	public Item(int barcode, String deviceType, String brand, String colour, String connectivity, int stockQuantity,
	...
	/**
	 * This is a parent class of Keyboard and Mouse. Takes the entire row as input
	 * 
	 * @param desc - Array of the item's description
	 */
	public Item(String[] desc) {
		this(Integer.parseInt(desc[0]), desc[2], desc[3], desc[4], desc[5], Integer.parseInt(desc[6]),
	...
	/**
	 * Get price of this single item
	 * 
	 * @return Singular retail price
	 */
	...
	public List<Object> getProperties(boolean getOGCost) {
		...
		if (getOGCost) {
			properties = new Object[] { this.barcode, this.deviceType, this.brand, this.colour, this.connectivity,
					this.stockQuantity, this.originalCost, this.retailPrice, };
		} else {
			properties = new Object[] { this.barcode, this.deviceType, this.brand, this.colour, this.connectivity,
					this.stockQuantity, this.retailPrice, };
		}
	...
	public int compareTo(Item o) {
		// Comparator, descending stock quantity.
